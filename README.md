...
Software Engineer building ERP/POS systems, developer tools, Arabic-first interfaces, and automation products.
...
- ERP/POS and business workflow systems
...
- Automation bots and operational utilities
- Educational software for junior developers
...
I am building developer-assistance tooling inspired by modern AI coding agents, with a strong focus on helping junior developers understand errors, break problems into steps, and learn through structured debugging workflows.

### ERP/POS systems

I build business software around cashier flows, inventory, reporting, admin dashboards, operational settings, and practical day-to-day business workflows.
...
- Data: SQL, database modeling, reporting workflows
- Product: ERP/POS workflows, dashboards, admin systems
- Tooling: GitHub, CLI tools, automation, AI-assisted coding workflows
- Interfaces: Arabic-first UI, RTL/LTR product systems
